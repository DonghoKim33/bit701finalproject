                        ...
                        <tr>
                            ...
                            <td className={'input-group'}>
                                <input type={'password'} className={'form-control'} placeholder={'비밀번호'} required
                                       value={mypass} style={{width:'120px'}}
                                       onChange={(e) => {
                            ...
                            <td>
                                <div className={'input-group'}>
                                    <input type={'text'} className={'form-control'} required
                                           value={myaddress1} readOnly/>

                                    <button type={'button'} className={'btn btn-outline-success'} onClick={handleClickOpen}>주소검색</button>
                                </div>
                                <div>
                                    <input type={'text'} className={'form-control'} value={myaddress2}
                                    onChange={(e)=>setMyaddress2(e.target.value)} placeholder={'상세주소를 입력해주세요'}/>
                                </div>
                            </td>
                        </tr>
